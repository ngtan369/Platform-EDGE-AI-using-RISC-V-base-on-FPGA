...
\begin{itemize}
    ...
    \item \textbf{Chức năng:} Hỗ trợ cơ chế \textit{Burst Transaction}, cho phép uDMA đọc/ghi liên tiếp tới 256 gói dữ liệu chỉ với một địa chỉ bắt đầu. Điều này cực kỳ quan trọng để cung cấp đủ băng thông pixel/trọng số cho bộ tăng tốc Conv-CNN, đặc biệt khi mở rộng lên các kiến trúc CNN sâu hơn ở các pha phát triển tiếp theo.
\end{itemize}
